...
function CustomersPage() {
  const { customers, loans, accounts, emis, addCustomer } = useStore();
    ...
    <div className="space-y-6 max-w-7xl mx-auto">
      ...
      <div className="flex flex-col sm:flex-row items-center gap-3">
        <div className="relative flex-1 w-full">
          ...
          <Input
            placeholder="Search by name, ID (CUS-xxx), mobile or city..."
            value={query}
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) => setField('nominee', { ...form.nominee, name: e.target.value })}
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) => setField('nominee', { ...form.nominee, relationship: e.target.value })}
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) => setField('nominee', { ...form.nominee, mobile: e.target.value })}
                      placeholder='10-digit mobile'
                      className='mt-1 h-9 text-xs'
                    />
                  </div>
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) => setField('nominee', { ...form.nominee, address: e.target.value })}
