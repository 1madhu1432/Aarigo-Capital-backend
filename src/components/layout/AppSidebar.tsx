      ...
      items: [
        {
          ...
          subItems: [
            ...
            { title: "Add Customer", href: "/customers?action=new" },
          ],
        },
        {
          title: "Accounts",
      ...
      items: [
        {
          ...
          subItems: [
            { title: "Active Loans", href: "/loans?status=Active" },
            { title: "Overdue Loans", href: "/loans?status=Overdue", badge: overdueLoansCount || undefined, badgeVariant: "destructive" },
            { title: "Closed Loans", href: "/loans?status=Closed" },
            { title: "New Loan", href: "/loans?action=new" },
          ],
        },
        {
          title: "EMI",
          ...
          subItems: [
            { title: "Today's Due", href: "/emi?status=due", badge: dueTodayEmiCount || undefined, badgeVariant: "secondary" },
            { title: "Upcoming", href: "/emi?status=upcoming" },
            { title: "Pending", href: "/emi?status=pending" },
            { title: "Overdue", href: "/emi?status=overdue", badge: overdueEmiCount || undefined, badgeVariant: "destructive" },
          ],
        },
      ],
    },
